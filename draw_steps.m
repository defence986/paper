...
% ourpath = 'E:\work\medical_section\code\video\input\';
fileName = '20161012T002740.uniform.avi';
ourpath = 'E:\work\medical_section\code\video\medium\';
...
Total = 0;
for i = 1:length(pointsAm)
    Temp1 = pointsAm(i).Location;
    Temp2 = pointsBm(i).Location;
    Total = Total + sqrt((Temp1(1)-Temp2(1))^2 + (Temp1(2)-Temp2(2))^2);
end
Avg = Total/length(pointsAm);
