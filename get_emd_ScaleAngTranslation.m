...
% balance_ang = 2.5;
balance_S = 0.999999;
balance_ang = 0.999999;
Ratio_Scale = cvx_estimation_ratio(imfS,Scale,balance_S);
emdS = ratio_emd(Ratio_Scale,imfS);
Ratio_ang = cvx_estimation_ratio(imfang,ang,balance_ang);
...
balance_T1 = 0.999999;
balance_T2 = 0.999999;
RatioT1 = cvx_estimation_ratio(imfT1,T1,balance_T1);
emdT1 = ratio_emd(RatioT1,imfT1);
RatioT2 = cvx_estimation_ratio(imfT2,T2,balance_T2);
emdT2 = ratio_emd(RatioT2,imfT2);

longitude = 5;
emdang = feature_centric(ang,emdang,longitude);
emdS = feature_centric(Scale,emdS,longitude);
...
filename = strcat('..\video\',datestr(now,30),'.avi');
